...
class UNet30(nn.Module):
    def __init__(self, n_channels, n_classes, bilinear=False):
        ...
        self.up1 = Up(2048, 1024 // factor, bilinear, k=(4,2))
        self.up2 = Up(1024, 512 // factor, bilinear, k=(4,2))
        self.up3 = Up(512, 256 // factor, bilinear, k=(4,2))
        self.up4 = Up(256, 128, bilinear, k=(2,2))
